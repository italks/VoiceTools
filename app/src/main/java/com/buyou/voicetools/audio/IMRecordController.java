...
import com.buyou.voicetools.utils.Permissions;
...
public class IMRecordController implements View.OnTouchListener, RecordStateListener {
    ...
    public boolean onTouch(final View v, final MotionEvent event) {
        String[] mNeededPermissions = new String[]{
                Manifest.permission.RECORD_AUDIO
        };
        Permissions.getInstance().quanxian(mContext,mNeededPermissions,0, new Permissions.Return_Nextstep() {
            @Override
