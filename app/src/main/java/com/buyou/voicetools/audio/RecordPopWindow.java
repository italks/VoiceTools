...
public class RecordPopWindow {
    ...
    public RecordPopWindow(Context context) {
        ...
        mRootView = LayoutInflater.from(mContext).inflate(R.layout.audio_view, null);
    ...
    public void startRecord() {
        ...
        mVoiceTipTv.setText(R.string.audio_chat_tip_3);
    ...
    public void setRubishTip() {
        ...
        mVoiceTipTv.setText(R.string.audio_chat_tip_4);
    }
